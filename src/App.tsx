          ...
          <div className="flex items-center justify-between py-5">
            <div className="">
              <svg
                ...
                width="1500"
                height="1512"
                viewBox="0 0 1500 1512"
              >
                <g transform="matrix(1,0,0,1,-1.073975494338356,0.6132761494470742)">
                  <svg
                    viewBox="0 0 245 247"
                  ...
                  >
                    <g
                      id="tight-bounds"
                      transform="matrix(1,0,0,1,0.17541599740860647,-0.09997365579206985)"
                    >
                      <svg
                        viewBox="0 0 244.6491463291139 247.2"
                        height="247.2"
                        width="244.6491463291139"
                      >
                        <g>
                          <svg
                            viewBox="0 0 244.6491463291139 247.2"
          ...
          <div className="w-full flex flex-wrap">
            <div className="w-full md:w-1/2">
              ...
              <p className="mt-7 text-gray-500">
                ...
                dreamed about doing something amazing and I am continuing my
                hard work to fulfill my dream {":)"}
              </p>
          ...
          <div className="mt-10 grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 p-7 cursor-pointer hover:shadow rounded">
              ...
              <p className="mt-1 text-xs text-gray-500 line-clamp-4">
                45+ industry standart project completed using modern
                technologies like Vue, React, Next JS, Tailwind, MUI, Ant Design
                and more.
              </p>
            </div>
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 p-7 cursor-pointer hover:shadow rounded">
              ...
              <p className="mt-1 text-xs text-gray-500 line-clamp-4">
                35+ existing projects and build from scratch. Managed high
                traffic. Mostly used PHP, Laravel, Express JS, Nest JS.
              </p>
            </div>
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 p-7 cursor-pointer hover:shadow rounded">
              <svg
            ...
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 p-7 cursor-pointer hover:shadow rounded">
              ...
              <p className="mt-1 text-xs text-gray-500 line-clamp-4">
                Project deployment in live server using docker, custom
                deployment, and Published Android and IOS applications.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="mt-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 cursor-pointer hover:shadow rounded">
              <img
                ...
                src="https://radwananik.com/jmr/qcoom.png"
                alt=""
              />

              <div className="p-5">
                <h2 className="uppercase text-sm">QCOOM-ECOMMERCE</h2>
                <p className="mt-1 text-xs text-gray-500 line-clamp-2">
                  E-Commerce platform using millions of users worlwide, mainly
                  in Bangladesh
                </p>
                <div className="mt-5 w-full flex items-center gap-3">
                  <div className="w-full flex items-center gap-2">
                    ...
                    <svg className="w-auto h-5" viewBox="0 0 48 31">
                      <path
                        fill-rule="evenodd"
                        clip-rule="evenodd"
            ...
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 cursor-pointer hover:shadow rounded">
              <img
                className="aspect-[16/9] rounded-t"
                src="https://radwananik.com/jmr/qdmin-qcoom.png"
                alt=""
              />

              <div className="p-5">
                <h2 className="uppercase text-sm">QCOOM: ADMIN</h2>
                <p className="mt-1 text-xs text-gray-500 line-clamp-2">
                  Admin panel where manages all qcoom services like qcoom.com,
                  qfood.com.bd, pickmeexpress.com and more
                </p>
                <div className="mt-5 w-full flex items-center gap-3">
                  <div className="w-full flex items-center gap-2">
                    <svg
            ...
            <div className="bg-slate-500 hover:bg-[#171819] bg-opacity-10 hover:bg-opacity-100 cursor-pointer hover:shadow rounded">
              <img
                className="aspect-[16/9] rounded-t"
                src="https://radwananik.com/jmr/qfood.png"
                alt=""
              />

              <div className="p-5">
                <h2 className="uppercase text-sm">QFOOD: FOOD & GROCERIES</h2>
                <p className="mt-1 text-xs text-gray-500 line-clamp-2">
                  Food delivery system using millions of users in Dhaka
                </p>
                <div className="mt-5 w-full flex items-center gap-3">
                  <div className="w-full flex items-center gap-2">
                    <svg
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 gap-4">
            ...
            <div className="w-40 h-40 flex flex-col items-center justify-center bg-[#171819] hover:bg-primary hover:bg-opacity-20 hover:shadow-lg p-5 rounded">
              <img
                ...
                alt="Nest JS"
              />
              <p className="mt-2 text-sm">Nest JS</p>
            </div>
          </div>
        </section>
      </main>
